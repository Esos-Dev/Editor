        ...
        $(document).ready(function() {
            ...
            shareml.onclick = function() {
                shareMail();
            }
            resetParamsBtn.onclick = function() {
                resetParams();
            }
            autoSaveSwitch.onchange = function() {
                setAutoSave();
            }
            autoSaveNum.onchange = function() {
                setAutoSave();
            }
            autoSaveSel.onchange = function() {
                setAutoSave();
            }
            textLinesSwitch.onchange = function() {
                setTextLines();
            }
            darkmodeSwitch.onchange = function() {
                darkModeToggle();
            }
            fontSizeNum.onchange = function() {
                setFont();
            }
            fontFamilySel.onchange = function() {
                setFont();
            }
            fontWeightSel.onchange = function() {
                setFont();
            }
            autoSaveDownBtn.onclick = function() {
                Save();
            }
            autoSavePrefBtn.onclick = function() {
                showPrefModal();
            } //!!!!!!!!!!!!!!!!!!!!<<<???
...
// Print Function By Esos
        ...
        function Print() {
            ...
            //win.document.open();
            // Uncomment the below line to add css effect
            //win.document.write('<html lang="en"><head></head><body style="font-size:' + params.fontSize + 'px">');
            // win.document.write('<html lang="en"><head></head><body>');

            win.document.write('<html lang="en"><head></head><body style="font-size:' + fontSizeNum.value + 'px; font-family:' + fontFamilySel.options[fontFamilySel.selectedIndex].text + '; font-weight:' + fontWeightSel.options[fontWeightSel.selectedIndex].text +'">');
